...
if st.session_state.get("ver_pantalla_tv", False):
    ...
    eventos = []
    avisos_vivos = []
    perfil = st.session_state.get("tv_profile", "Profesores / PIE")
    ...
    with col_agenda:
        ...
        with st.expander("⚙️ Ajustes de pantalla"):
            st.selectbox(
                "👁️ Perfil visual",
                ["Profesores / PIE", "General", "Inspectoría / UTP"],
                key="tv_profile",
            )
...
if not st.session_state.logged:
    ...
    with main_container:
        ...
        with col_form:
            ...
            st.markdown("<p style='text-align: center; color: gray; font-size: 0.9rem;'>Reservas, recursos, diplomas y monitor semanal · V23.1 · TV inicia en Profesores / PIE</p>", unsafe_allow_html=True)
            ...
            if st.button(
                ...
                # Perfil institucional por defecto solicitado: Profesores / PIE.
                st.session_state.tv_profile = "Profesores / PIE"
...
# ==============================================================================
    ...
    if st.session_state.get("ver_pantalla_tv", False):
        ...
        with col_der:
            ...
            st.selectbox("👁️ Perfil Visual", ["Profesores / PIE", "Inspectoría / UTP", "Apoderados"], key="tv_profile")
