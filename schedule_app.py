...
st.sidebar.markdown("---")
# ---------------------------------------------------------
        # RELOJ EN TIEMPO REAL Y MENSAJES MOTIVACIONALES (HTML/JS)
        # ---------------------------------------------------------
        html_reloj = """
        <!DOCTYPE html>
        <html>
        ...
        <style>
            ...
            @media (prefers-color-scheme: dark) {
                .container { background-color: #262730; color: #FAFAFA; }
                .reloj { color: #ff4b4b; }
                .mensaje { color: #c6c6d1; }
            }
            @media (prefers-color-scheme: light) {
                .container { background-color: #f0f2f6; color: #31333F; }
                .reloj { color: #ff4b4b; }
                .mensaje { color: #555555; }
            }
            .fecha { font-weight: 600; font-size: 1.05em; text-transform: capitalize;}
            .reloj { font-size: 1.6em; font-weight: 700; margin: 8px 0; font-variant-numeric: tabular-nums;}
            .mensaje { font-size: 0.85em; font-style: italic; }
        </style>
        </head>
        <body>
            <div class="container">
            ...
            <script>
                // Puedes agregar o cambiar los mensajes aquí
                const mensajes = [
                    "¡Que tengas un excelente día de clases! 📚",
                    "El conocimiento es poder. ¡A enseñar! 💡",
                    "Formando el futuro, un día a la vez. 🌱",
                    "¡Mucho éxito en tus labores hoy! ✨",
                    "Tu dedicación hace la diferencia. 🏫",
                    "Inspirando mentes, cambiando vidas. 🌟"
                ];
        ...
        # Insertar el código web en la barra lateral
        st.sidebar.components.v1.html(html_reloj, height=135)
