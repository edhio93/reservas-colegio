...
# ==============================================================================
    ...
    if st.session_state.get("ver_pantalla_tv", False):
        ...
        # 📺 2. MODO TV NORMAL (Diseño CSS Renovado)
        st.markdown(f"""
        <style>
            ...
            /* 🎨 DISEÑO DE TARJETAS DE CRONOGRAMA A TODO COLOR */
        ...
        with col_izq:
            ...
            try:
                ...
                for e in (res_ev.data or []):
                    ...
                    # 🕒 Filtro: Solo muestra si la hora actual es menor o igual a la hora de fin calculada
        ...
        with col_der:
            ...
            # 👇 CONTROLES LIMPIOS Y SIN BOTONES EXTRA 👇
